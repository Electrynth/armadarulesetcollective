...
function Rules() {
  const pdfFiles = [
    ...
    { name: 'Offensive Retrofits', compressedPath: '/pdfs/compressed/Offensive Retrofits.pdf', rawPath: '/pdfs/raw/Offensive Retrofit.pdf', compressedSize: '2.0MB', rawSize: '8.5MB' },
    { name: 'Defensive Retrofits', compressedPath: '/pdfs/compressed/Defensive Retrofits.pdf', rawPath: '/pdfs/raw/Defensive Retrofit.pdf', compressedSize: '738KB', rawSize: '3.0MB' },
    { name: 'Fleet Commands', compressedPath: '/pdfs/compressed/Fleet Commands.pdf', rawPath: '/pdfs/raw/Fleet Command.pdf', compressedSize: '1023KB', rawSize: '4.3MB' },
    ...
    { name: 'Ion Cannons', compressedPath: '/pdfs/compressed/Ion Cannons.pdf', rawPath: '/pdfs/raw/Ion Cannon.pdf', compressedSize: '768KB', rawSize: '3.3MB' },
