      ...
      <div className="max-w-6xl mx-auto mt-8">
        ...
        <div className="space-y-4">
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 0 ? 'max-h-96 py-4' : 'max-h-0'}`}>
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 1 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 2 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 3 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 4 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 6 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 7 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 8 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 9 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 10 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 11 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 12 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-xl ring-1 ring-gray-700/50 overflow-hidden">
            ...
            <div className={`px-6 overflow-hidden transition-all duration-300 ease-in-out ${openIndex === 13 ? 'max-h-96 py-4' : 'max-h-0'}`}>
              <p className="text-gray-300 leading-relaxed whitespace-pre-line">
